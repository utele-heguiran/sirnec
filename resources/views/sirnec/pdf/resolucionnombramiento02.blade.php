...
@section('textocarta')
    ...
    <br>
    <br>
    <div class="c"><strong>“Por medio de la cual se Efectua Nombramientos de Encargos en Provisionalidad”</strong></div>
    <br><br>
    ...
    <br>
    <div style="text-align: justify;"><strong>ARTÍCULO SEGUNDO: </strong>La remuneración del personal nombrado se fijará de acuerdo con lo establecido en el artículo 1° del Decreto 316 del 27 de febrero de 2020. <br><br><strong>ARTÍCULO TERCERO:</strong> De acuerdo con lo dispuesto por la ley 190 de 1995, en sus artículos 13, 14 y 15, para tomar posesión del cargo, el nominado deberá presentar declaración juramentada de bienes y rentas. <br><br><strong>ARTÍCULO CUARTO:</strong> Comunicación y Recursos. Comunicar la presente resolución al Grupo de Salarios y Prestaciones de la Delegacion y al nivel central, enviar coipa original a las historias laborales de los servidores que se relacionaron en el artículo 1ro de la presente resolución e informar que contra a presente no opera recurso alguno. <br><br></div>
    ...
    <div class="c"><strong>{{ strtoupper($dato->nombredelegado1) }}</strong>   @if ($delegado2encargos != "") -   <strong>{{ strtoupper($delegado2encargos->name) }}</strong> @else  @endif </div>
