            ...
            <div class="col-md-12">
                <table >
                    <thead>
                        ...
                        <tr>
                            <td class="b c t"  colspan="4" style="height: 20px">Devoluciones de material realizadas</td>
                            <td class="b c t" colspan="6">Reporte de las devoluciones de material procesado en el centro de acopio del departamento</td>
                        ...
                        <tr>
                            <td class="b c t"  colspan="4" style="height: 20px">Trámites procesados en el periodo </td>
                            <td class="b c t" colspan="6">Cantidad de trámites recepcionados en el periodo anterior incluyedo los que quedaron en estado terminado y las devoluciones remitidas al lugar de preparación.</td>
                        </tr>
                        <tr>
                            ...
                            <td class="b c t" >Formatos RAFT 04 y RAFT 06 </td>
                            <td class="b c t" colspan="2" >CARGO QUE SUMINISTRA Y ANALIZA LA INFORMACIÓN </td>
                            <td class="b c t" colspan="5" >ADMINISTRADOR DE CENTRO DE ACOPIO </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="b c t" >Menor o Igual al 3.5%  </td>
                            <td class="b c t" >RANGO REGULAR </td>
                            <td class="b c t" >Mayor o Igual a 3.5% y Menor al 5%</td>
                            <td class="b c t" >RANGO MALO</td>
                            <td class="b c t" >Mayor al 5% </td>
