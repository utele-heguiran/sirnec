...
@section('textocarta')
    ...
    <div style="text-align: justify;"><strong>ARTÍCULO PRIMERO: Encargar,</strong> Provisionalmente de manera discrecional en la planta global de la Delegacion del {{ ucwords(strtolower($dato->nombredepartamento)) }} en el cargo y fechas que se indican en los siguientes servidores asi:</div>
    <br>
    ...
    <br>
    <div style="text-align: justify;"><strong>ARTÍCULO SEGUNDO: Encargar,</strong> Provisionalmente de manera discrecional en la planta global de la Delegacion del {{ ucwords(strtolower($dato->nombredepartamento)) }} en el cargo y fechas que se indican en los siguientes servidores asi:
    ...
    <br>
    <div style="text-align: justify;"><strong>ARTÍCULO TERCERO:</strong>la duración de estos nombramientos provisionales y encargos serán hasta los días señalados inclusive, y finalizarán al termino del mismo, sin que para ello se requiera acto administrativo ni comunicación alguna, en todo caso podrán darse por terminados en cualquier momento. <br><br><strong>ARTÍCULO CUARTO:</strong>la Remuneración, del personal nombrado se fijará de acuerdo con lo establecido en el artículo 1° del Decreto 1029 del 6 de Julio de 2019. <br><br><strong>ARTÍCULO QUINTO:</strong>De acuerdo con lo dispuesto por la ley 190 de 1995, en sus artículos 13, 14 y 15, para tomar posesión del cargo, el nominado deberá presentar declaración juramentada de bienes y rentas. <br><br><strong>ARTÍCULO SEXTO:</strong>Comunicación y Recursos. Comunicar la presente resolución al Grupo de Salarios y Prestaciones de la Delegacion y al nivel central, enviar coipa original a las historias laborales de los servidores que se relacionaron en el artículo 1ro de la presente resolución e informar que contra a presente no opera recurso alguno.<br><br></div>
