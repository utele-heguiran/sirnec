                ...
                <table >
                    <thead>
                        <tr>
                            ...
                            <td class="b c" width="70" >RAFT05</td>
                        </tr>
                        <tr>
                            <td class="b c" >FORMATO</td>
                            <td class="b c" >REGISTRO DE CONTROL ENVÍO DE LOTES MUNICIPALES EN REGISTRADURÍA</td>
        ...
        <div class="col-md-12">
            <body >
                <table >
                    <thead >
                        <tr>
                            <td width="100" class="b c s ">NOMBRE DE LA OFICINA DE PREPARACION</td>
                            <td width="70" class="b c s fz">LOTE DEL MUNICIPIO (ALFANUMERICO)</td>
                            ...
                            <td width="30" class="b c s fz">CANT. DIAS TRASPORTE</td>
                            <td width="40" class="b c s fz">CANTIDAD DE DECADACTILARES ENVIADAS</td>
                            <td width="40" class="b c s fz">CONSECUTIVO DEL LOTE</td>
                            <td width="140" class="b c s ">NOVEDADES PRESENTADAS</td>
                        </tr>
                    </thead>
