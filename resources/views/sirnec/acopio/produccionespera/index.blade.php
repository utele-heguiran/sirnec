...
@section('guia') Produccion en Espera @endsection
...
@if (count($data) > 0)
    ...
    PRODUCCION EN ESPERA - CENTRO DE ACOPIO - {{ $row->nombredepartamento }}
    @else
    PRODUCCION EN ESPERA - CENTRO DE ACOPIO
@endif
    ...
    <a href="" data-toggle="modal" data-target="#crearproduccionespera"><img class="img-responsiveid float-right" style="width: 3%; height: 3%; margin-right: 8px; margin-top: -7px" src="{{ asset('images/espera.png') }}" title="Crear produccion en Espera" /></a>
...
@section('contenido')
        ...
        <div class="modal fade bd-example-modal-lg" name='crearproduccionespera' id="crearproduccionespera" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="exampleModalLongTitle" style="font-family: footlight MT Light, gabriola,Lucida Calligraphy; color: #006400;text-shadow: 4px 4px 4px rgb(99, 98, 98);">CREAR PRODUCCION EN ESPERA</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    {!! Form::open(['route' => 'produccion_espera_guardar', 'method'=>'POST', 'autocomplete'=> 'off', 'id' => 'produccionesperacrear', 'name' => 'produccionesperacrear' ]) !!}
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4"></div>
                            <div class="col-md-4" id="letra" >
                                <center>
                                    <strong  >MATERIAL SIN RECEPCIONAR</strong>
                                </center>
                            </div>
                            <div class="col-md-4"></div>
                        </div>
                        <div class="row" style="margin-top: 5px">
                            ...
                            <div class="col-md-2">
                                <center>
                                    <strong id="letra" style="border-style: solid; padding: 1px 10px 1px 10px;border-width: 1px;border-radius: 5px;">Comprobacion </strong>
                                    {!! Form::number('matsinrecepcionarcomprob', null, ['class' => 'form-control', 'id' => 'matsinrecepcionarcomprob', 'style' => 'margin-top: 5px']) !!}
                                </center>
                            </div>
                            <div class="col-md-2">
                                <center>
                                    <strong id="letra" style="border-style: solid; padding: 1px 10px 1px 10px;border-width: 1px;border-radius: 5px;">Escaneo</strong>
                                    {!! Form::number('matsinrecepcionarescaneo', null, ['class' => 'form-control', 'id' => 'matsinrecepcionarescaneo', 'style' => 'margin-top: 5px']) !!}
                                </center>
                            </div>
                            <div class="col-md-4"></div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12" style="padding: 10px; text-align: center;">
                                <a class="btn btn-info" href="{{ route('produccion_espera')}}" style="text-decoration:none;color:#FFFFFF" >Cerrar</a>
                                <button type="submit" class="btn btn-info" id="enviarproduccionespera">Crear Produccion en Espera</button>
                            </div>
                        </div>
        ...
        {{-- fin modal crear PRODUCCION EN ESPERA --}}

        {{-- modal generar raft 11 --}}
        <div class="modal fade bd-example-modal-lg" name='reporteraft11' id="reporteraft11" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="exampleModalLongTitle" style="font-family: footlight MT Light, gabriola,Lucida Calligraphy; color: #006400;text-shadow: 4px 4px 4px rgb(99, 98, 98);">GENERAR RAFT - 11</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    {!! Form::open(['route' => 'raft11pdf', 'method'=>'POST', 'autocomplete'=> 'off']) !!}
                        <div class="modal-body">
                            <div class="row">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            //valida el formulario antes de envio
                $('#enviarproduccionespera').click(function(){

                    var matsinrecepcionarcomprob = $('#matsinrecepcionarcomprob').val();
                    var matsinrecepcionarescaneo = $('#matsinrecepcionarescaneo').val();
                    ...
                    if( matsinrecepcionarcomprob == ""){ matsinrecepcionarcomprob = 0; document.getElementById("matsinrecepcionarcomprob").value = matsinrecepcionarcomprob; }
                    if( matsinrecepcionarescaneo == ""){ matsinrecepcionarescaneo = 0; document.getElementById("matsinrecepcionarescaneo").value = matsinrecepcionarescaneo; }
                    ...
                    total_escaneado = (parseInt(escaneo_pvc)+parseInt(escaneo_renovc)+parseInt(escaneo_rectc)+parseInt(escaneo_dupc)+parseInt(escaneo_pvt)+parseInt(escaneo_renovt)+parseInt(escaneo_rectt)+parseInt(escaneo_dupt)+parseInt(escaneo_noprocesado));
