...
@section('guia') Lotes @endsection
@section('linkencabezado') @endsection


@section('titulo') 
    LISTADO DE LOTES RECEPCIONADOS 
    ...
    <a href="" data-toggle="modal" data-target="#crearlote"><img class="img-responsiveid float-right" style="width: 3.1%; height: 3.1%; margin-right: 8px; margin-top: -7px" src="{{ asset('images/lotes.png')}}" title="Crear Lotes" /></a>
    <a href="" data-toggle="modal" data-target="#reporteraft04"><img class="img-responsiveid float-right" style="width: 3.1%; height: 3.1%; margin-right: 8px; margin-top: -7px" src="{{ asset('images/reportes.png')}}" title="Generar RAFT - 04" /></a>
...
@section('contenido')
        ...
        {{-- modal crear lote --}}
        <div class="modal fade bd-example-modal-lg" name='crearlote' id="crearlote" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="exampleModalLongTitle" style="font-family: footlight MT Light, gabriola,Lucida Calligraphy; color: #006400;text-shadow: 4px 4px 4px rgb(99, 98, 98);">CREACION DE LOTES</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    {!! Form::open(['route' => 'lotesacopio_guardar', 'method'=>'POST', 'autocomplete'=> 'off', 'id' => 'lotescrear', 'name' => 'lotescrear' ]) !!}
                    <div class="modal-body">
                        <div class="row">
                           <div class="col-md-3"></div>
                           <div class="col-md-4">{!! Form::select ('oficina_id', $oficinas, null, ['class'=>'form-control', 'id' => 'oficina_id', 'placeholder' => 'Seleccione La Oficina']) !!}</div>
                           <div class="col-md-2">{!! Form::text('numlote', null, ['class' => 'form-control', 'id' => 'numlote', 'placeholder' => 'No. Lote']) !!}</div>
                           <div class="col-md-3"></div>
                        </div>
                        <div class="row" style="margin-top: 10px">
                            <div class="col-md-3"></div>
                            <div class="col-md-2"><center><span style="font-family: footlight MT Light, gabriola,Lucida Calligraphy; color: #006400;text-shadow: 4px 4px 4px rgb(99, 98, 98);">FECHA CREACION LOTE</span></center>{!! Form::date('feccrealote', null, ['class'=>'form-control','id' => 'feccrealote' ]) !!}</div>
                            <div class="col-md-2"><center><span style="font-family: footlight MT Light, gabriola,Lucida Calligraphy; color: #006400;text-shadow: 4px 4px 4px rgb(99, 98, 98);">FECHA ENVIO LOTE</span></center> {!! Form::date('fecenvlote', null,  ['class'=>'form-control', 'id' => 'fecenvlote']) !!}</div>
                            <div class="col-md-2"><center><span style="font-family: footlight MT Light, gabriola,Lucida Calligraphy; color: #006400;text-shadow: 4px 4px 4px rgb(99, 98, 98);">FECHA RECEPCION LOTE</span></center> {!! Form::date('fecrecacopio', null, ['class'=>'form-control', 'id' => 'fecrecacopio']) !!}</div>
                            <div class="col-md-3"></div>
                        </div>
                        <div class="row" style="margin-top: 10px">
                            <div class="col-md-4"></div>
                            <div class="col-md-2">{!! Form::number('cantdecasrecibidas', null, ['class' => 'form-control', 'id' => 'cantdecasrecibidas', 'placeholder' => 'Cantidad de Decas']) !!}</div>
                            <div class="col-md-2">{!! Form::text('numoficenvio', null, ['class' => 'form-control', 'id' => 'numoficenvio', 'placeholder' => 'Oficio de Envio No.']) !!}</div>
                            <div class="col-md-4"></div>
                        </div>
                        <div class="row" style="margin-top: 10px" >
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                <div class="input-group" >
                                    ...
                                    <textarea class="form-control" name="novedad" aria-label="With textarea"></textarea>
                                </div>
                            </div>    
                            <div class="col-md-4"></div> 
                        </div>
                        <div class="row" style="margin-top: 10px">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-4"></div>
                                    <div class="col-md-4">
                                        <center><span style="font-family: footlight MT Light, gabriola,Lucida Calligraphy; color: #006400;text-shadow: 4px 4px 4px rgb(99, 98, 98);">ANULADOS</span></center>
                                        {!! Form::number('numpreparacionanulados', null, ['class' => 'form-control', 'id' => 'numpreparacionanulados',]) !!}
                                    </div>
                                    <div class="col-md-4"></div>
                                </div>
                                <br>
                                <div class="row" style="margin-top: -20px">
                                    ...
                                    <div class="col-md-8">
                                        <table  class="table table-hover text-center" data-toggle="dataTable" style="width:100%"  >
                                            ...
                                            <tbody id="anulados-tabla" style="font-size: 12px;" >
                                ...
                                <div id="variablesanulados"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-4"></div>
                                    <div class="col-md-4">
                                        <center><span style="font-family: footlight MT Light, gabriola,Lucida Calligraphy; color: #006400;text-shadow: 4px 4px 4px rgb(99, 98, 98);">FALTANTES</span></center>
                                        {!! Form::number('numpreparacionfaltantes', null, ['class' => 'form-control', 'id' => 'numpreparacionfaltantes',]) !!}
                                    </div>
                                    <div class="col-md-4"></div>
                                </div>
                                <br>
                                <div class="row" style="margin-top: -20px">
                                    ...
                                    <div class="col-md-8">
                                        <table  class="table table-hover text-center" data-toggle="dataTable" style="width:100%"  >
                                            ...
                                            <tbody id="faltantes-tabla" style="font-size: 12px;">
                               ...
                               <div id="variablesfaltantes"></div>
                               <div id="diastransporte"></div>
                            </div>
                        </div>
                        ...
                        <br>
                            ...
                            <div class="row">
                                <div class="col-12" style="padding: 10px; text-align: center;">
                                    <a class="btn btn-info" href="{{ route('lotesacopio')}}" style="text-decoration:none;color:#FFFFFF" >Cerrar</a>
                                    <button type="submit" class="btn btn-info" id="enviarlote">Crear Lote</button>
                                </div>
                            </div>
        ...
        {{-- fin modal crear lote --}}

        {{-- modal generar raft 04 --}}
        <div class="modal fade bd-example-modal-lg" name='reporteraft04' id="reporteraft04" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="exampleModalLongTitle" style="font-family: footlight MT Light, gabriola,Lucida Calligraphy; color: #006400;text-shadow: 4px 4px 4px rgb(99, 98, 98);">GENERAR RAFT - 04</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    {!! Form::open(['route' => 'raft04pdf', 'method'=>'POST', 'autocomplete'=> 'off']) !!}
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-3"></div>
                                <div class="col-md-3">
